                ...
                <thead className="">
                  {Array.from({ length: raw.length }).map((_, key) => (
                    <tr key={key} className="">
                      <th className="p-3 text-left md:w-fit">No.</th>
                      ...
                      <th className="p-3 text-left">สิทธิ</th>
                ...
                <tbody className="flex-1 md:flex-none">
                  {raw.map((curr, index) => (
                    <tr key={index} className="flex flex-col flex-nowrap md:table-row mb-2 md:mb-0">
                      ...
                      <td className="border rounded-md p-3 whitespace-nowrap">
                        <span className={classRole(curr.role_id)}>
                          {roleJSON.filter((item) => item.id === curr.role_id)[0].title}
                        </span>
                      </td>
                      <td className="border rounded-md p-3">
