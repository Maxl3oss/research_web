      ...
      <Fragment>
         <div className={`${isOpen ? "blur-sm sticky" : ""} relative layout-theme`}>
            ...
            <main className="flex h-full md:px-0 px-2">
               <div className={(sliceSide === null ? "layout-size" : sliceSide ? "md:max-w-[calc(100vw_-_200px)] md:ml-[200px]" : "md:max-w-[calc(100vw_-_80px)] md:ml-[80px]") + " max-w-full flex-grow p-2 sm:p-5 min-h-[91vh] h-full transition-all duration-200 translate-x-0"}>
                  <Outlet />
               </div>
            </main>
            {/* <Footer /> */}
